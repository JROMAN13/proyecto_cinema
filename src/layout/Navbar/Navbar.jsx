...
const Navbar = (props) => {
  ...
  // const [dataRecibida,setDataRecibida]=useState({cinema:""})
  // const bringdataSelected = (data) => {
      ...
      <nav className="bg-black border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            ...
            <span className="textPrimary self-center text-xl font-medium whitespace-nowrap text-gray-200">
              CINE COLOMBIA
            </span>
          </a>
          ...
          <div
            className="items-center  hidden w-2/4 md:flex md:w-auto md:order-1"
            id="navbar-user"
          >
            <ul
              className={`flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-black md:space-x-4 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black ${
            ...
            >
              <li>
                <a
                  href="#"
                  className="block py-2 px-4 text-white rounded-full bg-blue-button"
                >
                  Acción
                </a>
              </li>
          ...
          <FilterMoviesAvailable handleSelection={props.handleSelection}   />
        </div>
      </nav>
    </>
  );
