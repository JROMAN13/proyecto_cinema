  ...
  return (
    <>
        <div className="flex w-full justify-between">
            <div className="w-1/2 ml-60 mt-20 p-20 ">
                <h2 className="text-2xl font-bold">Información personal</h2>
                <span>Complete los datos del formulario para realizar el pago.</span>
            ...
            <div className=" ml-20 mt-20 p-20 w-full">
